...
class MediaMixin(object):
    ...
    class Media:
        css = {'screen':('cms_contrib/admin/widgets/charsleft/css/charsleft.css',),}
        js = ('cms_contrib/admin/widgets/charsleft/js/charsleft.js',)
    
class CharsLeftTextInput(forms.TextInput, MediaMixin):
